        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mx-auto mb-2 mb-lg-0 d-flex gap-4">
            <li className="nav-item">
              <Link className="nav-link text-light" to="/Portfolio/#/home">Home</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link text-light" to="/Portfolio/#/about">About</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link text-light" to="/Portfolio/#/resume">Resume</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link text-light" to="/Portfolio/#/project">Projects</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link text-light" to="/Portfolio/#/contact">Contacts</Link>
            </li>
          </ul>
